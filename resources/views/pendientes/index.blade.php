                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-footer">
                            ...
                            <form
                                action="{{ route('pendientes.recibir', $despacho) }}"
                                method="POST"
                            >
                                ...
                                <button
                                    ...
                                    onclick="return confirm('¿Confirmar que este despacho fue recibido en tienda?')"
                                >
    ...
    @else
        ...
        <div class="card">
            ...
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted">
                    Todos los despachos enviados han sido recibidos.
                </p>
